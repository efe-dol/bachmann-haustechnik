...
const waterTopics = [
  {
    ...
    text: "Reduzierung von Kalkablagerungen, Schonung von Geräten und Rohren, Verbesserung der Haut- und Haarqualität, verschleiß- und energiesparend, geringerer Reinigungsaufwand",
  },
  {
    title: "Filteranlagen",
    text: "Entfernung von Eisen, Mangan, Schwermetallen und anderen Schadstoffen",
  },
];

export default function WassertechnikPage() {
    ...
    <main className="min-h-screen bg-gradient-to-br from-sky-50 via-blue-50 to-cyan-50 px-6 pt-0 pb-12 text-zinc-900 md:px-10">
      ...
      <div className="mx-auto w-full max-w-6xl pt-40">
        <section className="anim-soft-enter anim-delay-1 rounded-3xl border border-white/70 bg-white/85 p-8 shadow-2xl backdrop-blur-md md:p-10">
          ...
          <p className="anim-text-enter anim-delay-4 mt-4 text-base leading-relaxed text-zinc-700 md:text-lg">
            Weiches Wasser - mehr Komfort und weniger Kosten
          </p>

          <div className="mt-8 grid gap-4 md:grid-cols-2">
            {waterTopics.map((item, index) => (
              <article
                key={item.title}
                className={`${index === 0 ? "anim-soft-enter anim-delay-2" : "anim-soft-enter anim-delay-3"} rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm`}
              >
